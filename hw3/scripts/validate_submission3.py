...
def get_submitters(temp_folder):    
    ...
    if not os.path.join(temp_folder, 'policy_api.h'):
	raise Exception('No policy_api.h file - Invalid format')
    ...
    print 'Tip: use the make_changed.py script to validate your extracted zip will compile sucessfully'
